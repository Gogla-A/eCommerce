...
return [
    ...
    */
    ...
    'Offer Name' => 'إســم العــرض',
    'Offer Price' => 'سعــر العــرض',
    'Offer Details' => 'تفاصيــل العــرض',
    'Make your offer' => 'إختـر العــرض الخـاص بك',
    'Enter Offer Name' => 'أدخــل إسـم العـرض',
    'Enter Offer Price' => 'أدخــل سعـر العـرض',
    'Enter Offer Details' => 'أدخــل تفاصيــل العـرض',
    'Submit' => 'حفـــظ',
...
'Offer Details Are Required' => 'تفاصيـل العـرض مطلـوبة',
    ...
    'data stored successfully' => 'تم تخزين البيانات بنجاح',
